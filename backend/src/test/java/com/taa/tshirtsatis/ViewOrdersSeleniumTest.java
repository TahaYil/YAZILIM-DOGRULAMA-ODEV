    ...
    public void testLoginAndViewOrders() {
        ...
        try {
            ...
            for (WebElement header : headers) {
                ...
                if (headerText.contains("Order ID") || headerText.contains("ID")) hasOrderIdColumn = true;
                if (headerText.contains("Date")) hasDateColumn = true;
                if (headerText.contains("State")) hasStateColumn = true;
            }
